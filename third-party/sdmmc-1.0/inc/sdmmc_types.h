...
#define SDMMC_OK          0       /* sdmmc_err_t value indicating success (no error) */
#define SDMMC_FAIL        -1      /* Generic sdmmc_err_t code indicating failure */

#define SDMMC_ERR_NO_MEM              0x101   /* Out of memory */
#define SDMMC_ERR_INVALID_ARG         0x102   /* Invalid argument */
#define SDMMC_ERR_INVALID_STATE       0x103   /* Invalid state */
#define SDMMC_ERR_INVALID_SIZE        0x104   /* Invalid size */
#define SDMMC_ERR_NOT_FOUND           0x105   /* Requested resource not found */
#define SDMMC_ERR_NOT_SUPPORTED       0x106   /* Operation or feature not supported */
...
#define SDMMC_ERR_SEND_CMD_FAILED     0x10C   /* Send command failed */
#define SDMMC_ERR_NOT_READY           0x10D   /* Host not ready */
...
#define SDMMC_HOST_FLAG_SDIO    BIT(6)      /* host supports SDIO */
...
#define SDMMC_FREQ_25M          25000
#define SDMMC_FREQ_26M          26000       /* MMC 26MHz speed */
#define SDMMC_FREQ_50M          50000       /* SD/MMC 50MHz high speed */
    float io_voltage;           /* I/O voltage used by the controller (voltage switching is not supported) */
    sdmmc_err_t (*init)(int slot);    /* Host function to initialize the driver */
    ...
    sdmmc_err_t (*io_int_wait)(int slot, TickType_t timeout_ticks); /* Host function to wait for SDIO interrupt line to be active */   
