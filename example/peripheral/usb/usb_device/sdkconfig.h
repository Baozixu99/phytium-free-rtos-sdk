...
#define CONFIG_TARGET_NAME "pusb2_lib"
...
#define CONFIG_IMAGE_MAX_LENGTH 0x50000000
...
#define CONFIG_CHERRY_USB_PORT_PUSB2
/* CONFIG_CHERRY_USB_PORT_PUSB3 is not set */
/* CONFIG_CHERRYUSB_HOST is not set */
#define CONFIG_CHERRYUSB_DEVICE
#define CONFIG_CHERRY_USB_DEVICE_MSC
#define CONFIG_CHERRY_USB_DEVICE_CDC
#define CONFIG_CHERRY_USB_DEVICE_HID
#define CONFIG_CHERRY_USB_DEVICE_VEDIO
/* CONFIG_CHERRY_USB_PORT_SOURCE_CODE is not set */
#define CONFIG_CHERRY_USB_PORT_STATIC_LIB
