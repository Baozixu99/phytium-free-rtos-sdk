...
### 2.7 输出与实验现象 (PD2408 Test A 板，使用 XHCI 1)

- 将 USB 设备连接在 USB 1 控制器上

![pd2408_usb_host](./figs/pd2408_usb_host.jpg)
...
![pd2408_usb_start](./figs/pd2408_usb_start.png)
...
![pd2408_usb_list](./figs/pd2408_usb_list.png)

- 读写 U 盘设备 /dev/sda

```
usbh mscrw 1 /dev/sda
```

![pd2408_msc_rw](./figs/pd2408_msc_rw.png)

```
usbh mscbench 1 /dev/sda
```

![pd2408_msc_bench](./figs/pd2408_msc_bench.png)

- 使用鼠标

```
usbh mouse 1 /dev/input0
```

![pd2408_mouse](./figs/pd2408_mouse.png)

- 使用键盘

```
usbh kbd 1 /dev/input1
```

![pd2408_keyboard](./figs/pd2408_keyboard.png)

### 2.8 输出与实验现象 (PD2408 Test A 板，使用 PCIe XHCI)

- 将 USB 设备连接在 PCIe XHCI USB 控制器上

![pd2408_pcie_xhci_host](./figs/pd2408_pcie_xhci_host.jpg)
...
![pd2408_pcie_xhci_devices](./figs/pd2408_pcie_xhci_devices.png)
