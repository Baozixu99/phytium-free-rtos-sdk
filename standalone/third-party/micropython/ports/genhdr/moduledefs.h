...
#define MODULE_DEF_HASHLIB \
    {MP_ROM_QSTR(MP_QSTR_hashlib), MP_ROM_PTR(&mp_module_hashlib)},
...
#define MODULE_DEF__ASYNCIO \
    {MP_ROM_QSTR(MP_QSTR__asyncio), MP_ROM_PTR(&mp_module_asyncio)},
...
#define MICROPY_MODULE_DELEGATIONS \
    {MP_ROM_PTR(&mp_module_sys), mp_module_sys_attr}, // MICROPY_MODULE_DELEGATIONS
