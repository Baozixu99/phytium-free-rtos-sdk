 ...
 *
 *
 * FilePath: pusb2_usb_disk_read_write_example.c
...
/*****************************************************************************/
static void PUSB2UsbMscTask(void *args)
{
    int ret;
    u8 id = (u8)usb_id;
...
BaseType_t FFreeRTOSRunPUSB2Disk(u32 id, const char *devname)
{
    ...
    ret = xTaskCreate((TaskFunction_t)PUSB2UsbMscTask,
                      (const char *)"PUSB2UsbMscTask",
                      (uint16_t)4096,
                      (void *)devname,
