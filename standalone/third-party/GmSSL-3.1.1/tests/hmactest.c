...
#endif
{
	...
	for (i = 0; i < sizeof(hmac_tests)/sizeof(hmac_tests[0]); i++) {
		test_hmac((DIGEST *)DIGEST_sha224(), hmac_tests[i].key, hmac_tests[i].data, hmac_tests[i].hmac_sha224);
		test_hmac((DIGEST *)DIGEST_sha256(), hmac_tests[i].key, hmac_tests[i].data, hmac_tests[i].hmac_sha256);
		test_hmac((DIGEST *)DIGEST_sha384(), hmac_tests[i].key, hmac_tests[i].data, hmac_tests[i].hmac_sha384);
		test_hmac((DIGEST *)DIGEST_sha512(), hmac_tests[i].key, hmac_tests[i].data, hmac_tests[i].hmac_sha512);
	};
