...
static int USBCmdEntry(int argc, char *argv[])
{
    ...
    else if (!strcmp(argv[1], "disk"))
    {
        ...
        ret = FFreeRTOSRunPUSB2Disk(usb_id, devname);
    }
    else if (!strcmp(argv[1], "diskbench"))
    {
        ...
        ret = FFreeRTOSRunPUSB2DiskBench(usb_id, devname);
    }
    else if (!strcmp(argv[1], "keyboard"))
    {
        ...
        ret = FFreeRTOSRunPUSB2Keyboard(usb_id, devname);
    }
    else if (!strcmp(argv[1], "mouse"))
    {
        ...
        ret = FFreeRTOSRunPUSB2Mouse(usb_id, devname);
    }
