...
/**
 * Probe and initialize eMMC using given host
 *
 * @note Only eMMC are supported for this function.
 *
 * @param host  pointer to structure defining host controller
 * @param out_card  pointer to structure which will receive information
 *                  about the card when the function completes
...
/**
 * Probe and initialize TF cards (SDHC/SDXC) using given host
 *
 * @note Only TF are supported for this function.
 *
 * @param host  pointer to structure defining host controller
 * @param out_card  pointer to structure which will receive information
 *                  about the card when the function completes
