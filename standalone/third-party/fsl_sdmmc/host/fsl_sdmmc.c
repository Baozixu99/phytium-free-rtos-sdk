...
#if defined(CONFIG_FSL_SDMMC_ENABLE_MMC)
extern status_t FSDIFV2_HOST_MMCConfig(sdmmc_mmc_t *sdmmc, sdmmchost_config_t *config);
#endif
#if defined(CONFIG_FSL_SDMMC_ENABLE_SD)
extern status_t FSDIFV2_HOST_SDConfig(sdmmc_sd_t *sdmmc, sdmmchost_config_t *config);
#endif
extern status_t FSDIFV2_HOST_Init(sdmmchost_t *host);
#endif
