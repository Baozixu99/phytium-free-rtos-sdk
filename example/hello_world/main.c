...
static void vTimerCallback( TimerHandle_t pxTimer )
{
	...
	if (lTimerId != TIMER_ID) {
		printf("FreeRTOS Hello World Example FAILED, id is %d - %d\r\n", 
				lTimerId, TIMER_ID);
	}
	...
	if (RxtaskCntr >= TIMER_CHECK_THRESHOLD) {
		...
		printf("FreeRTOS Hello World Example FAILED, task cnt %d\r\n", RxtaskCntr);
	}
