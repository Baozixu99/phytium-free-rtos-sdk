...
#ifndef _SDMMC_COMMON_H_
#define _SDMMC_COMMON_H_
...
static inline bool host_support_sdio(const sdmmc_card_t* card)
{
    return (card->host.flags & SDMMC_HOST_FLAG_SDIO) != 0;        
}
