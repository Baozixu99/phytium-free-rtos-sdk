...
#elif defined(CONFIG_TARGET_PE2201) 
#define SHELL_PLATFORM      "E2000S  "
#elif defined(CONFIG_TARGET_PD2308) 
#define SHELL_PLATFORM      "PD2308  "
#elif defined(CONFIG_TARGET_PD2408)
#define SHELL_PLATFORM      "PD2408  "
...
#define SHELL_BOARD         "PD2408-TEST-A-BOARD  "
#elif defined(CONFIG_PD2408_TEST_B_BOARD)
#define SHELL_BOARD         "PD2408-TEST-B-BOARD  "
#else
