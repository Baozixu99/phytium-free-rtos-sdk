 ...
 *
 *
 * FilePath: fspim_msg_os.h
 * Date: 2025-04-15 10:09:31
 * LastEditTime: 2025-04-15 10:09:31
 * Description:  This file is for providing function related definitions of spi msg master driver used in FreeRTOS.
 *
 * Modify History:
...
#ifndef  FSPIM_MSG_OS_H
#define  FSPIM_MSG_OS_H
/***************************** Include Files *********************************/
...
#define FFREERTOS_SPIM_XFER_ERR             FT_CODE_ERR(ErrModPort, ErrBspSpi, 5)
...
FFreeRTOSSpim *FFreeRTOSSpimMsgInit(u32 instance_id, const FFreeRTOSSpimConifg *config);
...
FError FFreeRTOSSpimMsgTransfer(FFreeRTOSSpim *const instance, FFreeRTOSSpiMessage *message);
