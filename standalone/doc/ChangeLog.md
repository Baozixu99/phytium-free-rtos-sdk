# Phytium Standalone SDK 2025-10-20 v1.5.0 ChangeLog

Change Log since 2025-10-16

## common

-  add ftrace_printk function

# Phytium Standalone SDK 2025-10-16 ChangeLog

Change Log since 2025-10-16

## third-party

-  ​​Resolve MMC module compiler optimization issues​​

# Phytium Standalone SDK 2025-10-15 ChangeLog

Change Log since 2025-10-15

## third-party

-  modify ping.c and add dns server

## example

-  add lwip dns example

# Phytium Standalone SDK 2025-10-14 ChangeLog

Change Log since 2025-10-14
...
-  add system gmssl with gmssl example.
# Phytium Standalone SDK 2025-10-14 ChangeLog
...
- fix acpi bug in multi-core boot
- add mmu_unmap function in fbootcore.c

## example

- add ps2316 acpi example

## soc

- add core_affinity number of core8~15
...
-  add cJSON-1.7.19 repository

## example

-  add cJSON test example

# Phytium Standalone SDK 2025-10-09 ChangeLog

Change Log since 2025-10-09

## third-party

-  Changes to the lwiport.h file for seL4 adaptation.

# Phytium Standalone SDK 2025-9-26 ChangeLog

Change Log since 2025-09-25

## third-party

-  Modify the interrupt enable interface.

# Phytium Standalone SDK 2025-09-25 ChangeLog

Change Log since 2025-09-24

## drivers

- update mhu driver to support ps2316

## soc

- add ps2316 soc support

# Phytium Standalone SDK 2025-09-24 ChangeLog

Change Log since 2025-09-23

## third-party

- Add Makefile logic adapted for the seL4 xmac use case.
- Add FLwipDCacheRangeInvalidate and other cache functions specifically for lwip in cc.c to facilitate port expansion.

# Phytium Standalone SDK 2025-09-23 ChangeLog

Change Log since 2025-09-23

## example

- add smp and amp debugging instructions

# Phytium Standalone SDK 2025-09-10 ChangeLog

Change Log since 2025-09-10

## arch

- add aarch64 gdb stub function

## example

- add gdb stub example

# Phytium Standalone SDK 2025-09-10 ChangeLog

Change Log since 2025-09-02

## example

- remove libbsd example
- add acpi example
...
# Phytium Standalone SDK 2025-09-02 ChangeLog

Change Log since 2025-09-02

## drivers

- Modify i2c msg driver，add FI2cMsgSpeedModeInfo structure

# Phytium Standalone SDK 2025-08-29 ChangeLog

Change Log since 2025-08-28

## drivers

- Modify uart driver to support dumping the registers of the uart device.

## example

- remove FUartMsgFormat struct bauderate in example

# Phytium Standalone SDK 2025-08-28 ChangeLog

Change Log since 2025-08-25

## drivers

- refine include files for drivers

# Phytium Standalone SDK 2025-08-20 ChangeLog

Change Log since 2025-08-20

## third-party

- format code using clang-format under third-party port directory
...
- format code using clang-format under example directory

# Phytium Standalone SDK 2025-08-20 ChangeLog

Change Log since 2025-08-19

## drivers

- format code using clang-format

# Phytium Standalone SDK 2025-08-19 ChangeLog

Change Log since 2025-08-18

- update .gitlab-ci.yml and .clang-format to support clang-format check

## arch, common, board, soc

- format code using clang-format

## .gitlab

- update convention.md and add add use_clang_format.md

# Phytium Standalone SDK 2025-08-18 ChangeLog

Change Log since 2025-08-13

## example

- update serial interrput example

## driver

- add scmi power protocol 

# Phytium Standalone SDK 2025-08-13 ChangeLog

Change Log since 2025-08-12

## example
- update network config

## third-party
- Optimize fxmac interrupt switch efficiency

# Phytium Standalone SDK 2025-08-12 ChangeLog

Change Log since 2025-08-07

## driver

- add msi-x driver
- add pcie device driver (nvme)
- driver port add  list struct

# Phytium Standalone SDK 2025-08-07 ChangeLog

Change Log since 2025-08-01

## arch

- add MmuInitSecondary function for secondary core init
- rename rdis to rdist, rename dis to dist in gicv3 files

## common

- add InterruptSecondaryInit function for secondary core init

# Phytium Standalone SDK 2025-08-07 ChangeLog

Change Log since 2025-07-21

## common

- Added a configurable option to switch virtual timers​​, enabling rapid toggling between timer types.

## third-party

- ​​Introduced COVERAGE_SRC_PATH parameter​​ to detect bare-metal environments.

## tools

- Adapt to the seL4 system.

# Phytium Standalone SDK 2025-08-04 ChangeLog

Change Log since 2025-07-31

## arch

- support uefi loader to pass rdsp address

## example

- add libbsd acpi device example, show how to use libbsd driver model with acpi
- add libbsd fdt device example, show how to use libbsd driver model with fdt
- add libbsd acpi utilites example. show how to use acpi cpu scale

## third-party

- port freebsd/netbsd driver model as part of libbsd

# Phytium Standalone SDK 2025-07-31 ChangeLog

Change Log since 2025-07-28

## third-party

- move version.h to third-party/openamp/lib
- VIRTIO_CACHED_RSC_TABLE is deprecated, delete it

# Phytium Standalone SDK 2025-07-28 ChangeLog

Change Log since 2025-07-28

## arch 

- add barrier to solve the gicv3 issue
# Phytium Standalone SDK 2025-07-25 ChangeLog

Change Log since 2025-07-25

## driver

- modify add psci get cpuid ability

## example

- modify add psci_test.c cmd for psci cpu_version

# Phytium Standalone SDK 2025-07-21 ChangeLog

Change Log since 2025-07-17

## arch

- modify KB, MB, GB definition

## example

- update example defination

## third-party

- libmetal update to v1.8.0
- openamp update to v1.8.0

# Phytium Standalone SDK 2025-07-17 ChangeLog

Change Log since 2025-07-15

## drivers

- repair an bug about mode set

# Phytium Standalone SDK 2025-07-15 ChangeLog

Change Log since 2025-07-09

## arch

- repair sata_pcie msi bug

# Phytium Standalone SDK 2025-07-09 ChangeLog

Change Log since 2025-07-09

## drivers

- add init_flg to config uart driver

## soc

- select the uart init function according to the application
...
- add dcdp driver for pd2408

## example

- change some example config for pd2408

# Phytium Standalone SDK 2025-07-02 ChangeLog

Change Log since 2025-07-01

## board

- update pd2408 test a&b board config
...
- add network example config

## third-party

- add hash

# Phytium Standalone SDK 2025-07-01 ChangeLog

Change Log since 2025-06-25

## thiry-party

- add spiffs on fsim_v2_sfud configs

# Phytium Standalone SDK 2025-06-25 ChangeLog

Change Log since 2025-06-24

## drivers

- refactor spi_v2 drivers

# Phytium Standalone SDK 2025-06-23 ChangeLog

Change Log since 2025-06-23
...
- modify qspi example driver

# Phytium Standalone SDK 2025-06-24 ChangeLog

Change Log since 2025-06-20

## drivers 

- Update xmac v2 drivers

# Phytium Standalone SDK 2025-06-20 ChangeLog
...
# Phytium Standalone SDK 2025-06-19 ChangeLog

Change Log since 2025-06-19

## example 

- test example and add some pd2408_test_a config

# Phytium Standalone SDK 2025-06-18 ChangeLog

Change Log since 2025-06-18

## example 

- test example and add some config

# Phytium Standalone SDK 2025-06-17 ChangeLog

Change Log since 2025-06-16

## arch

- rename CONFIG_ARM64_PA_BITS

## board

- add gpio iopad config
...
- repair msi interrupt bug in fgic_its.c
...
# Phytium Standalone SDK 2025-06-16 ChangeLog

Change Log since 2025-06-13

## drivers

- remove the FPl011CfgGeneralInitialize function

## example

- add gicv3、amp、psci、scmi config for pd2408

# Phytium Standalone SDK 2025-06-13 ChangeLog
...
# Phytium Standalone SDK 2025-06-10 ChangeLog

Change Log since 2025-06-10

## drivers

- modify pwm, qspi, sata, wdt driver to adapt to pd2408

## example

- add pd2408 config, modify readme

## soc

- modify fparameters.h to adapt to pd2408
...
- add i2c_msg and i2s_msg and codec_msg driver

## example 

- add example for pd2408

# Phytium Standalone SDK 2025-06-06 ChangeLog

Change Log since 2025-06-06

## arch

- update the gicv3 driver
...
- add spi_msg and sfud_msg example
...
# Phytium Standalone SDK 2025-06-05 ChangeLog

Change Log since 2025-06-05

## board 

- add PD2408 config and board infomation

## soc 

- add PD2408 soc config and board infomation

## doc 

- add some introduce for PD2408

## drivers

- change usb driver with PD2408

## third-party 

- change cherry-usb

# Phytium Standalone SDK 2025-05-21 ChangeLog

Change Log since 2025-05-21
...
- Add device driver, es8336 driver, es8388 driver
...
# Phytium Standalone SDK 2025-05-19 ChangeLog

Change Log since 2025-05-19
...
# Phytium Standalone SDK 2025-05-16 ChangeLog

Change Log since 2025-05-13

## driver

- modify pwm, tacho, i2c and mio drivers and parameters

## example

- modify pwm, tacho, i2c examples

# Phytium Standalone SDK 2025-05-12 ChangeLog

Change Log since 2025-05-07

## common

- Use macro definitions to provide timer selection for rpr step.

# Phytium Standalone SDK 2025-05-07 ChangeLog

Change Log since 2025-05-06

## example

- modify mac frame readme

# Phytium Standalone SDK 2025-05-06 ChangeLog

Change Log since 2025-04-30

## example

- add e2000d config for can_spi example

## board

- add e2000d gpio5-9 iomux

# Phytium Standalone SDK 2025-04-30 ChangeLog

Change Log since 2025-04-28

## arch

- add support for 16K/64K granule size

# Phytium Standalone SDK 2025-04-28 ChangeLog

Change Log since 2025-04-10

## tools

- add tools for auto_test
...
# Phytium Standalone SDK 2025-04-2 ChangeLog

Change Log since 2025-04-2

## doc

- change gitlab-ci.yml add loop test stage
...
add <sys/_stdint.h> in cmd_md.h to avoid build error in xpack compiler chain.
...
- fix the bug of scmi-mhu driver

# Phytium Standalone SDK 2025-3-7 ChangeLog

Change Log since 2025-3-4

## driver

- update the driver of scmi-mhu
- fix the bug of scmi-mhu driver

## example

- update the example of scmi-mhu

## tools

- add alldefconfig to the make defconfig command

# Phytium Standalone SDK 2025-3-4 ChangeLog

Change Log since 2024-3-3

## example

- update the example of openamp_for_linux to support the latest version of openamp

## tools

- update the tools of MSDF to support the latest version of configs

# Phytium Standalone SDK 2025-3-3 ChangeLog

## arch

- add CONFIG_ENABLE_GIC_ITS
...
# Phytium Standalone SDK 2025-1-15 ChangeLog

## example

- modify media driver

# Phytium Standalone SDK 2024-12-25 ChangeLog

Change Log since 2024-12-24

## example

- modify d2000 qspi example

# Phytium Standalone SDK 2024-12-20 ChangeLog

Change Log since 2024-12-14

## driver

- Optimize the address pointers of gmac transceiver descriptors and data buffers, divided into physical address and virtual address

# Phytium Standalone SDK 2024-12-16 ChangeLog

Change Log since 2024-12-13

## driver

- fix the 10-bit address bug of iic driver

# Phytium Standalone SDK 2024-12-13 ChangeLog

Change Log since 2024-12-12

## example

- change i2s example to solve ddma irq
- delete i2s boarder test example

# Phytium Standalone SDK 2024-12-12 ChangeLog

Change Log since 2024-12-05

## driver

- Sata supports 64-bit addressing when using expand memory space

# Phytium Standalone SDK 2024-12-09 ChangeLog

Change Log since 2024-12-02
...
- change example for adapting to the new dcdp driver

# Phytium Standalone SDK 2024-12-02 ChangeLog

Change Log since 2024-11-09

## arch

- add FBootCore function to support booting
- adjust the debug print level
- use MSDF (multi-core system deployment framework)

## example

- all multi-core examples support MSDF

## tools

- modify python tools to support MSDF

# Phytium Standalone SDK 2024-11-19 ChangeLog

Change Log since 2024-11-06

## driver

- add buf_dma to the FSdmmcData struct

## third-party

- fix the problem in FSDMMCHOST_CovertCommandInfo

# Phytium Standalone SDK 2024-10-30 ChangeLog

Change Log since 2024-10-28

## common

- refine efficiency of printing information

# Phytium Standalone SDK 2024-10-15 ChangeLog
...
# Phytium Standalone SDK 2024-10-14 ChangeLog
...
Solve the data section copy out of bounds problem

# Phytium Standalone SDK 2024-09-05 ChangeLog

Change Log since 2024-08-29

## third-party

- change tslf folder and .mk

# Phytium Standalone SDK 2024-08-29 ChangeLog
...
Change Log since 2024-08-27

# driver

- modify the dcdp driver to support the x100
- update the dcdp library

# example

- add example of using the x100
- change some examples to support the test automation

# Phytium Standalone SDK 2024-08-27 ChangeLog

Change Log since 2024-08-15

# driver

- Modify the i2c driver to support the i2c rtos
...
1. Added qemu4 core configuration

# Phytium Standalone SDK 2024-08-15 ChangeLog

Change Log since 2024-08-15

# tools

Optimize cppcheck misrac tools

## arch

- Modify code to comply with misra_c_2012_rule_10_X

# Phytium Standalone SDK 2024-08-16 ChangeLog

Change Log since 2024-08-12

# arch

Decouple the relationship between gic redistributor and cpu core
...
# Phytium Standalone SDK 2024-08-13 ChangeLog
...
- modify the i2c driver

# Phytium Standalone SDK 2024-08-12 ChangeLog

Change Log since 2024-08-08

## common

- Update FDebugSpinLock function by using mcs lock node

## example

- Update amp_tools_example by using mcs lock and mcs lock node

## soc

- Update SpinLock function by using mcs lock

# Phytium Standalone SDK 2024-08-09 ChangeLog

Change Log since 2024-08-09

## third-party

- Add more xhci/pusb2 statis lib for rtos with different fpu setting

# Phytium Standalone SDK 2024-08-09 ChangeLog

Change Log since 2024-08-06

## arch

- Modify code to comply with misra_c_2012_rule_10_3

## driver

- Modify some of the code to comply with misra_c_2012_rule_10_3
...
- add msi example for sata
- add lpi test for gicv3
...
- Remove unused fxhci drivers

## example

- Add pusb2 (device mode) example

## third-party

- Move cherryusb from freertos to standalone

# Phytium Standalone SDK 2024-08-06 ChangeLog

Change Log since 2024-08-05

## example

- add lwip sntp example

## third-party

- add lwip sntp application

# Phytium Standalone SDK 2024-08-05 ChangeLog

Change Log since 2024-08-01

## .gitlab-ci

- add board test pipeline
...
Change Log since 2024-07-08

## drivers

- modify sdif driver with 100MHz

## board

- add 66MHz、100MHz sdif timing

## example

- modify sdif tf、emmc disk bench
- add fatfs diskio、fileio bench

## third-party

- modify sdif diskio
- modify fsl sdmmc porting for disk bench

# Phytium Standalone SDK 2024-07-09 ChangeLog

Change Log since 2024-07-08

## example

- fix bug: uart example timeout

# Phytium Standalone SDK 2024-07-08 ChangeLog

Change Log since 2024-07-05

## example

- modify the amp example to support auto-test mode
...
Change Log since 2024-06-27

## common

add <sys/_stdint.h> in ftypes.h to avoid build error in xpack compiler chain.
...
- modify default pwm id in firefly board
- remove adc example

## soc

- refine soc parameters
...
- modify spi FSpimFifoTx bug

# Phytium Standalone SDK 2024-06-26 ChangeLog

Change Log since 2024-06-20

## board

- add support for AMP_PACK

## common

- remove config menu "Image information configuration"

## example

- update defalut config for all examples
- add example to test openamp life cycle management
- all amp examples support packed-image mode

## third-party

- adjust the openamp port function to support packed-image mode

## tools

- modifed the pythontools to support packed-image mode
- adjust the bootcode tool to support packed-image mode

# Phytium Standalone SDK 2024-06-20 ChangeLog

Change Log since 2024-06-19

## common

- remove GenericTimerStart in some unnecessary functions
...
- add some el2 registers for trace

## common

- get rpr steps in interrupt initialization

# Phytium Standalone SDK 2024-06-12 ChangeLog

## example

- change some example and deinit function

# Phytium Standalone SDK 2024-06-11 ChangeLog

Change Log since 2024-06-11

## third-party

- add sfud chip erase time feature

# Phytium Standalone SDK 2024-06-11 ChangeLog

Change Log since 2024-06-06

## example

- change tftboot to tftpboot
- change some example for no device

## thir-party

- change sd retry time
- change FSDIFHOST_PollingCardDetectStatus function to support no sd card detect

# Phytium Standalone SDK 2024-06-06 ChangeLog

Change Log since 2024-06-03

## arch

- add the mmu function

## example

- add mmu example

# Phytium Standalone SDK 2024-06-03 ChangeLog

Change Log since 2024-05-31
...
- modify can driver to support dma mode
...
- add example to test delay interface
...
- Refactoring spin lock

# Phytium Standalone SDK 2024-05-27 ChangeLog

Change Log since 2024-05-21

## drivers

- modify spi driver, add cs change api
- solve FSpimSetSpeed() func

## example

- add spi_flash_example and sfud_spi_multi_slave_example

# Phytium Standalone SDK 2024-05-21 ChangeLog

Change Log since 2024-05-21

## tools

- add refresh_config.py

# Phytium Standalone SDK 2024-05-21 ChangeLog

Change Log since 2024-05-20

## drivers

- added 8-byte access
- update gpio intr driver

## example

- update qspi example following qspi drivers

# Phytium Standalone SDK 2024-05-20 ChangeLog

Change Log since 2024-05-20

## common

- add common.kconfig ELOG_LINE_BUF_SIZE
...
- change timer driver to support  restart and free_run mode
- change driver to support roll interrupt mode

## example

- delete some unused code in tacho example
- change tacho example to support driver

# Phytium Standalone SDK 2024-05-14 ChangeLog

Change Log since 2024-05-13

## drivers

- added the condition judgment when can sends and receives

## example

- modify filter example

# Phytium Standalone SDK 2024-05-13 ChangeLog

Change Log since 2024-05-06

## drivers

- synchronised with linux on the FXmacSelectClk function, which allows mac to work nomally in rgmii 100M mode.

## third-party

- add recv_count to avoid endless FXmacRecvHandler call when dealing with a large influx of packets, causing packet not to go into lwip stack.

# Phytium Standalone SDK 2024-05-09 ChangeLog

Change Log since 2024-05-07

## drivers

- add high speed mode for i2c

## example

- change i2c and readme for adding high speed mode

# Phytium Standalone SDK 2024-05-07 v1.3.1 ChangeLog

Change Log since 2024-04-30

## arch

- Set PE mode to System in FInterruptNestedEnable macro definition

## drivers

- fix FCAN_TX_FIFO_FULL judgment condition

# Phytium Standalone SDK 2024-04-30 ChangeLog

Change Log since 2024-04-29

## example

- add i2s example for supporting es8388 and pd2308

## drivers

- add es8388 driver and change i2s driver to support es8388

# Phytium Standalone SDK 2024-04-29 ChangeLog

Change Log since 2024-04-29

- solve problem that network example can not compile successfully with ping.c in no letter-shell mode

# Phytium Standalone SDK 2024-04-28 ChangeLog

Change Log since 2024-04-26

## example

- change tacho example so that it can be set with different work mode parameters

# Phytium Standalone SDK 2024-04-26 ChangeLog
...
- add PhytiumPI FIOPadSetPwmMux

# Phytium Standalone SDK 2024-04-15 ChangeLog

Change Log since 2024-04-15

- add .gitlab-ci.yml file to start gitlab CI/CD func

# Phytium Standalone SDK 2024-04-12 ChangeLog

Change Log since 2024-04-12
...
- modify faarch.h clz definition

# Phytium Standalone SDK 2024-04-11 ChangeLog

Change Log since 2024-04-11

## drivers

- remove some unused variables from xmac

# Phytium Standalone SDK 2024-04-10 ChangeLog

Change Log since 2024-04-07

## drivers

- delete redundant code and adjust code format

## example

- update all network example configs, which make ping app added by default when compiling code
- adjust code format:delete redundant space after \r\n when using function printf

## third-party

- modified code of ping.c,which support ping host with ipv4
- delete redundant code and adjust code format
- add new macro DEFAULT_RAW_RECVMBOX_SIZE in lwipopts.h,which solved freertos can not ping using socket problem
...
- remove boot_code
- rename new_boot_code to boot_code

# Phytium Standalone SDK 2024-04-09 ChangeLog

Change Log since 2024-04-09

## example

- spiffs example debug
...
- compile drviers/port only for baremental
- fix sdif driver oversize bug when buffer size not times of 0x1000

## third-party

- fix lwip delay calls

# Phytium Standalone SDK 2024-04-03 ChangeLog

Change Log since 2024-03-25

## example

- delete CONFIG_LWIP_RX_POLL,which means interrupt context have been used in packet receiving
- change CONFIG_IP_REASS_MAX_PBUFS:16->32
- all network example config are updated

## third-party

- modify function ethernetif_input to increase packet processing speed
- interrupt handling packet changed to interrupt context handling packet,which solved high load ping timeout problems
- add macro ARP_QUEUE_LEN in lwipopts.h,which solved first ping a big packet timeout problem
...
- modify FPsciInit function

## tool

- modify aarch32_ram.ld
...
- add ai TinyMaix example

## third party

- add TinyMaix

# Phytium Standalone SDK 2024-03-28 ChangeLog

Change Log since 2024-3-27

## example

- modify libmetal example, adopt a new way of construction

# Phytium Standalone SDK 2024-03-27 ChangeLog

Change Log since 2024-3-27

## example

- solve the problem of pwm cycle and duty deviation
...
- delete can triggers tranmission code

# Phytium Standalone SDK 2024-03-26 ChangeLog

Change Log since 2024-03-26

## example

- add ddma sfud_probe_example
- add ddma sfud_wr_example
- normalize ddma spim_lookback_example
- add content in readme

## third party

- add ddma_sufd transfer api

## board

- modify some error info to warn info in firefly
- add sfud_board cfg files in board

## drivers

- optimize spi poll transfert api

# Phytium Standalone SDK 2024-03-26 ChangeLog

Change Log since 2024-3-25
...
- modify the i2s and es8336 driver
...
# Phytium Standalone SDK 2024-03-08 ChangeLog
...
# Phytium Standalone SDK 2024-03-12 ChangeLog
...
- Add openamp cache policy

##tools

- Update L3 cache policy of new boot code
...
Change Log since 2024-03-07

## board

- Add pd2308 demo board
...
- Modify some test examples for automated testing

# Phytium Standalone SDK 2024-03-05 ChangeLog
...
- Change the obtaining mode of the gic redistributor base address
...
- update FGicRedistributorInit function to accommodate jailhouse
