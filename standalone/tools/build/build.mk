...
IMAGE_OUT_NAME ?=  $(SOC_PRINTF_NAME)$(CONFIG_TARGET_TYPE_NAME)_$(CONFIG_ARCH_EXECUTION_STATE)_$(CONFIG_BOARD_NAME)_$(CONFIG_TARGET_NAME)
...
ifdef CONFIG_OUTPUT_ASM_DIS
	...
	@echo "  SOC    $(SOC_PRINTF_NAME)$(CONFIG_TARGET_TYPE_NAME)"
