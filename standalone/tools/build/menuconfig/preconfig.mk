...
ifeq ($(CONFIG_SOC_NAME),"pe220x")
    SOC_PRINTF_NAME :=
else
    SOC_PRINTF_NAME := $(CONFIG_SOC_NAME)
endif

backup_kconfig:
	$(PYTHON) $(SDK_KCONFIG_DIR)/savedefconfig.py --kconfig=Kconfig --out=$(CONFIGS_OUTPUT_PATH)/$(CONFIGS_PATH_NAME)/$(SOC_PRINTF_NAME)$(CONFIG_TARGET_TYPE_NAME)_$(CONFIG_ARCH_EXECUTION_STATE)_$(CONFIG_BOARD_NAME)_$(CONFIG_TARGET_NAME).config
	@echo "${GREEN}The configuration file of $(SOC_PRINTF_NAME)$(CONFIG_TARGET_TYPE_NAME)_$(CONFIG_ARCH_EXECUTION_STATE)_$(CONFIG_BOARD_NAME)_$(CONFIG_TARGET_NAME) is successfully backed up.${NC}" 
