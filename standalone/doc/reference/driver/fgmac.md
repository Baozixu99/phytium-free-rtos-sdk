...
```c
FError FGmacSetupTxDescRing(FGmac *instance_p, volatile FGmacDmaDesc *tx_desc_tbl, uintptr tx_desc_tbl_phys_addr,
                            u8 *tx_buf, uintptr tx_buf_phys_addr, const fsize_t tx_pre_buf_len, const fsize_t tx_buf_num);
```
...
```c
FError FGmacSetupRxDescRing(FGmac *instance_p, volatile FGmacDmaDesc *rx_desc_tbl, uintptr rx_desc_tbl_phys_addr,
                            u8 *rx_buf, uintptr rx_buf_phys_addr, const fsize_t rx_pre_buf_len, const fsize_t rx_buf_num);
```
